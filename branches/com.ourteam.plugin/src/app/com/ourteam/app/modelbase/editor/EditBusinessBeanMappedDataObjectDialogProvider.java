...
public class EditBusinessBeanMappedDataObjectDialogProvider extends
		AbstractEditBusinessObjectRelationDialogProvider {

	private ModelObjectMappingConfigComposite objectMappingComposite;

	public EditBusinessBeanMappedDataObjectDialogProvider(
	...
	protected String getTabbedPaneConfigId() {
		return "businessBeanMappedDataObjectConfigTab";
	}
