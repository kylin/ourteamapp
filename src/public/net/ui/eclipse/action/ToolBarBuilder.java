...
public class ToolBarBuilder extends AbstractActionGroupBuilder<IToolBarManager> {

	public ToolBarBuilder(IToolBarManager contributionManager,
	...
	@Override
	protected void buildSubActionItems(IToolBarManager contributionManager,
			...
			IMenuCreator menuCreator = new IMenuCreator() {
				...
				private void createDropDownMenuMgr(IActionHandler actionHandler) {
					if (dropDownMenuMgr == null) {
						...
						menuBuilder = new MenuBuilder(ToolBarBuilder.this,
								dropDownMenuMgr,
								new ActionGroupBean[] { actionGroupBean },
								actionHandler,
								ToolBarBuilder.this.getCustomActionable()) {

							@Override
							public IActionHandler getActionHandler() {
								return ToolBarBuilder.this.getActionHandler();
							}
				...
				public Menu getMenu(Menu parent) {
					createDropDownMenuMgr(ToolBarBuilder.this
							.getActionHandler());
