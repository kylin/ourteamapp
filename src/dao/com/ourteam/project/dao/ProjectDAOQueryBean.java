...
/**
 * Project query bean 2011-09-22 10:17:46
 *
 * @author Auto Gen
 */
public class ProjectDAOQueryBean extends BaseQueryBean {
    /**
     * Creates a new ProjectDAOQueryBean object.
     */
    public ProjectDAOQueryBean() {
        super();
    } // end ProjectDAOQueryBean()
     ...
     */
    public ProjectDAOQueryBean(BaseQueryBean aQueryBean) {
        super(aQueryBean);
    } // end ProjectDAOQueryBean()
     ...
     */
    public ProjectDAOQueryBean(BaseQueryBean aQueryBean, Map tableReplaceMap) {
    ...
    public void addIdSelectProperty(String aAlias) {
        if (StringUtils.isNotBlank(aAlias)) {
            addSelectProperty(IProjectDAO.Id, aAlias);
        } // end if
        else {
            addSelectProperty(IProjectDAO.Id, "id");
        } // end else
    } // end addIdSelectProperty()
    ...
    public void addDescriptionSelectProperty(String aAlias) {
        if (StringUtils.isNotBlank(aAlias)) {
            addSelectProperty(IProjectDAO.Description, aAlias);
        } // end if
        else {
            addSelectProperty(IProjectDAO.Description, "description");
        } // end else
    } // end addDescriptionSelectProperty()
    ...
    public void addNameSelectProperty(String aAlias) {
        if (StringUtils.isNotBlank(aAlias)) {
            addSelectProperty(IProjectDAO.Name, aAlias);
        } // end if
        else {
            addSelectProperty(IProjectDAO.Name, "name");
        } // end else
    } // end addNameSelectProperty()
    ...
    public void addStatusSelectProperty(String aAlias) {
        if (StringUtils.isNotBlank(aAlias)) {
            addSelectProperty(IProjectDAO.Status, aAlias);
        } // end if
        else {
            addSelectProperty(IProjectDAO.Status, "status");
        } // end else
    } // end addStatusSelectProperty()
    ...
    public static class Criteria extends BaseWhereCriterion {
        ...
        public Criteria andIdIsNotEmpty() {
            addCriterion("PROJECT.ID is not null AND PROJECT.ID <> ''");
        ...
        public Criteria andIdIsEmpty() {
            addCriterion("(PROJECT.ID is null OR PROJECT.ID = '')");
        ...
        public Criteria andIdEqualToForeignKey(java.lang.String key) {
            StringBuffer str = new StringBuffer("PROJECT.ID");
        ...
        public Criteria andIdNotEqualToOrIsNull(java.lang.Long value) {
            addCriterion("PROJECT.ID is null OR PROJECT.ID <>", value, "id");
        ...
        public Criteria andIdIn(Object[] values) {
            if (values.length == 1) {
                ...
                addCriterion("PROJECT.ID in", Arrays.asList(values), "id");
        ...
        public Criteria andIdNotIn(Object[] values) {
            if (values.length == 1) {
                ...
                addCriterion("PROJECT.ID not in", Arrays.asList(values), "id");
        ...
        public Criteria andDescriptionIsNull() {
            addCriterion("PROJECT.DESCRIPTION is null");
        ...
        public Criteria andDescriptionIsNotNull() {
            addCriterion("PROJECT.DESCRIPTION is not null");
        ...
        public Criteria andDescriptionIsNotEmpty() {
            addCriterion(
                "PROJECT.DESCRIPTION is not null AND PROJECT.DESCRIPTION <> ''");
        ...
        public Criteria andDescriptionIsEmpty() {
            addCriterion(
                "(PROJECT.DESCRIPTION is null OR PROJECT.DESCRIPTION = '')");
        ...
        public Criteria andDescriptionEqualTo(String value) {
            addCriterion("PROJECT.DESCRIPTION =", value, "description");
        ...
        public Criteria andDescriptionEqualToForeignKey(java.lang.String key) {
            StringBuffer str = new StringBuffer("PROJECT.DESCRIPTION");
            str.append(" = ").append(key);
            addForeignKeyCriterion(str.toString());
        ...
        public Criteria andDescriptionNotEqualToOrIsNull(String value) {
            addCriterion("PROJECT.DESCRIPTION is null OR PROJECT.DESCRIPTION <>",
                value, "description");
        ...
        public Criteria andDescriptionLike(String value) {
            ...
            buffer.append(value);
            buffer.append("%");
            addCriterion("PROJECT.DESCRIPTION like", buffer.toString(),
                "description");
        ...
        public Criteria andDescriptionNotLike(String value) {
            ...
            buffer.append(value);
            buffer.append("%");
            addCriterion("PROJECT.DESCRIPTION not like", buffer.toString(),
                "description");
        ...
        public Criteria andDescriptionIn(List values) {
            if (values.size() == 1) {
                ...
                addCriterion("PROJECT.DESCRIPTION in", values, "description");
        ...
        public Criteria andDescriptionNotIn(List values) {
            if (values.size() == 1) {
                ...
                addCriterion("PROJECT.DESCRIPTION not in", values, "description");
        ...
        public Criteria andDescriptionIn(Object[] values) {
            if (values.length == 1) {
                ...
                addCriterion("PROJECT.DESCRIPTION in", Arrays.asList(values),
                    "description");
        ...
        public Criteria andDescriptionNotIn(Object[] values) {
            if (values.length == 1) {
                ...
                addCriterion("PROJECT.DESCRIPTION not in",
        ...
        public Criteria andDescriptionBetween(String value1, String value2) {
            addCriterion("PROJECT.DESCRIPTION between", value1, value2,
                "description");
        ...
        public Criteria andDescriptionNotBetween(String value1, String value2) {
            addCriterion("PROJECT.DESCRIPTION not between", value1, value2,
                "description");
        ...
        public Criteria andNameIsNotEmpty() {
            addCriterion("PROJECT.NAME is not null AND PROJECT.NAME <> ''");
        ...
        public Criteria andNameIsEmpty() {
            addCriterion("(PROJECT.NAME is null OR PROJECT.NAME = '')");
        ...
        public Criteria andNameEqualToForeignKey(java.lang.String key) {
            StringBuffer str = new StringBuffer("PROJECT.NAME");
            str.append(" = ").append(key);
            addForeignKeyCriterion(str.toString());
        ...
        public Criteria andNameNotEqualToOrIsNull(String value) {
            addCriterion("PROJECT.NAME is null OR PROJECT.NAME <>", value,
                "name");
        ...
        public Criteria andNameLike(String value) {
            ...
            buffer.append(value);
            buffer.append("%");
            addCriterion("PROJECT.NAME like", buffer.toString(), "name");
        ...
        public Criteria andNameNotLike(String value) {
            ...
            buffer.append(value);
            buffer.append("%");
            addCriterion("PROJECT.NAME not like", buffer.toString(), "name");
        ...
        public Criteria andNameIn(Object[] values) {
            if (values.length == 1) {
                ...
                addCriterion("PROJECT.NAME in", Arrays.asList(values), "name");
        ...
        public Criteria andNameNotIn(Object[] values) {
            if (values.length == 1) {
                ...
                addCriterion("PROJECT.NAME not in", Arrays.asList(values),
                    "name");
        ...
        public Criteria andStatusIsNotEmpty() {
            addCriterion("PROJECT.STATUS is not null AND PROJECT.STATUS <> ''");
        ...
        public Criteria andStatusIsEmpty() {
            addCriterion("(PROJECT.STATUS is null OR PROJECT.STATUS = '')");
        ...
        public Criteria andStatusEqualToForeignKey(java.lang.String key) {
            StringBuffer str = new StringBuffer("PROJECT.STATUS");
            str.append(" = ").append(key);
            addForeignKeyCriterion(str.toString());
        ...
        public Criteria andStatusNotEqualToOrIsNull(String value) {
            addCriterion("PROJECT.STATUS is null OR PROJECT.STATUS <>", value,
                "status");
        ...
        public Criteria andStatusLike(String value) {
            ...
            buffer.append(value);
            buffer.append("%");
            addCriterion("PROJECT.STATUS like", buffer.toString(), "status");
        ...
        public Criteria andStatusNotLike(String value) {
            ...
            buffer.append(value);
            buffer.append("%");
            addCriterion("PROJECT.STATUS not like", buffer.toString(), "status");
        ...
        public Criteria andStatusIn(Object[] values) {
            if (values.length == 1) {
                ...
                addCriterion("PROJECT.STATUS in", Arrays.asList(values),
                    "status");
        ...
        public Criteria andStatusNotIn(Object[] values) {
            if (values.length == 1) {
                ...
                addCriterion("PROJECT.STATUS not in", Arrays.asList(values),
                    "status");
